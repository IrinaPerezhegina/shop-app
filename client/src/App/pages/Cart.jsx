...
import ModalOrder from "../components/ui/modalWindows/modalOrder";
                            ...
                            {productsCart.length > 0 ? (
                                <section className={styles.cart}>
                                    <header className={styles.cart_header}>
                                        <div
                                            className={styles.cart_headerTitle}
                                        >
                                            product name
                                        </div>
                                        <div
                                            className={styles.cart_headerColor}
                                        >
                                            color
                                        </div>
                                        ...
                                        <div
                                            className={styles.cart_headerCount}
                                        >
                                            quantity
                                        </div>
                                    ...
                                    <div className={styles.cart_footer}>
                                        <div
                                            className={styles.cart_footerCount}
                                        >
                                            {getCountsByBasket() +
                                                wordEnding(getCountsByBasket())}
                                        </div>
                                        <div
                                            className={styles.cart_footerPrice}
                                        >
                                            {getPricesOfBasket() + " $"}
                                        </div>
                                    </div>
